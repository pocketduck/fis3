define('script/common/urls', function(require, exports, module) {
  ...
  var _commonfun = require('script/common/commonfun');
  ...
  var urls = {
       ...
       */
      post: function post(url, params, success, before, fail, after) {
          if (before) {
              before();
          }
          ...
          params.ak = _commonfun2['default'].getQueryString('ak');
          params.service_id = _commonfun2['default'].getQueryString('service_id');
          //params.ak = 'SvGRjj1SPwTweSECeQarvBwqeeBUuzpd'
          //params.service_id = '131196'
          $.ajax({
              type: 'POST',
              url: url,
              data: params,
       ...
       * @param {function} before 请求前函数
       */
      jsonp: function jsonp(url, params, callback, before) {
          var that = this;
          if (before) {
              before();
          }

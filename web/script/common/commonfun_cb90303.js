define('script/common/commonfun', function(require, exports, module) {
  ...
  var commonfun = {
       ...
       * @return {array} 处理后的数组
       */
      removeFromArray: function removeFromArray(arr, val) {
       ...
       */
      getOnlineStatus: function getOnlineStatus(time) {
          var status = 0;
      ...
      * @return {string} 速度
      */
      getSpeed: function getSpeed(speed) {
          var speedDesc;
          if (speed >= 1) {
       ...
       * @return {array} 状态
       */
      getInfoWindowStatus: function getInfoWindowStatus(speed, time, direction) {
          var statusArr = [];
          speed = speed || 0;

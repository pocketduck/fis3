define('script/modules/entitycontrol/stores/entityStore', function(require, exports, module) {
  ...
  var EntityStore = Reflux.createStore({
      listenables: [_actionsEntityAction2['default']],
      init: function init() {},
      data: {
          // 总entity数据数量
          total: 0,
       ...
       */
      setEntities: function setEntities(data) {
          var that = this;
          ...
          data.entities.map(function (item) {
              ...
              _commonUrls2['default'].jsonp(_commonUrls2['default'].getAddress, paramsGeo, function (dataGeo) {
                  ...
                  that.data.entities.push([['entity_name', item.entity_name], ['create_time', item.create_time], ['local_address', dataGeo.result.formatted_address === '' ? '无' : dataGeo.result.formatted_address], ['loc_time', _commonCommonfun2['default'].getLocalTime(item.latest_location.loc_time)]].concat(temp));
       ...
       */
      onList: function onList(pageindex) {
          var that = this;
       ...
       * @return {array} 新的数组
       */
      formatColumn: function formatColumn(columns) {
       ...
       */
      onUpdatecheck: function onUpdatecheck(data) {
       ...
       *
       */
      setsearchentity: function setsearchentity(data) {

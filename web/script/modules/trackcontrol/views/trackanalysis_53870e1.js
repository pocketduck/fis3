define('script/modules/trackcontrol/views/trackanalysis', function(require, exports, module) {
  ...
  var TrackAnalysis = _react2['default'].createClass({
      displayName: 'TrackAnalysis',
       ...
       *
       */
      getLocalStorageSet: function getLocalStorageSet() {
          var that = this;
          ...
          var tempBehaviorCheck = [localStorage.speeding != undefined ? localStorage.speeding : '0', localStorage.harsh != undefined ? localStorage.harsh : '0', localStorage.steer != undefined ? localStorage.steer : '0', localStorage.stay != undefined ? localStorage.stay : '0'];
       ...
       *
       */
      setLocalStorageSet: function setLocalStorageSet() {
          var that = this;
       ...
       * @param {data} 驾驶行为数据
       */
      listenAnalysisBehavior: function listenAnalysisBehavior(data) {
          var that = this;
          var temp = {
          ...
          var breakingPoints = [];
          for (var i = 0; i < data.harsh_breaking.length; i++) {
              breakingPoints[i] = {
          ...
          var steeringPoints = [];
          for (var i = 0; i < data.harsh_steering.length; i++) {
              steeringPoints[i] = {
          ...
          var speekingPoints = [];
          for (var i = 0; i < data.speeding.length; i++) {
              speekingPoints[i] = {
       ...
       * @param {data} 驾驶行为数据
       */
      listenStaypoint: function listenStaypoint(data) {
          var that = this;
       ...
       */
      handleProcessSwitch: function handleProcessSwitch(event) {
          var that = this;
       ...
       * @param {object} event 事件对象 
       */
      handleBehaviorSwitch: function handleBehaviorSwitch(event) {
          var that = this;
       ...
       * @param {object} event 事件对象 
       */
      handleToggleProcess: function handleToggleProcess(event) {
          var that = this;
       ...
       * @param {object} event 事件对象 
       */
      handleToggleBehavior: function handleToggleBehavior(event) {
          var that = this;
       ...
       */
      updateTrackProcess: function updateTrackProcess(data) {
          var that = this;
          _actionsTrackAction2['default'].updateprocess(data);
          _actionsTrackAction2['default'].selecttrack();
       ...
       * @param {array} 显示状态
       */
      updateAnalysisBehavior: function updateAnalysisBehavior(data) {
          var that = this;
      ...
      render: function render() {
          ...
          return _react2['default'].createElement(
              'div',
              { className: tabIndex === 0 ? 'trackAnalysis hidden' : 'trackAnalysis visible', style: parentVisible },
              _react2['default'].createElement(
                  'div',
                  { className: 'trackAnalysisHeader' },
                  _react2['default'].createElement(
                      'div',
                      { className: analysisHeaderTitle1, onClick: handleToggleProcess },
                      '轨迹纠偏'
                  ),
                  _react2['default'].createElement('div', { className: analysisHeaderPoint1, onClick: handleToggleProcess }),
                  _react2['default'].createElement('div', { className: 'analysisHeaderLine' }),
                  _react2['default'].createElement(
                      'div',
                      { className: analysisHeaderTitle2, onClick: handleToggleBehavior },
                      '驾驶行为分析'
                  ),
                  _react2['default'].createElement('div', { className: analysisHeaderPoint2, onClick: handleToggleBehavior })
              ),
              _react2['default'].createElement(
                  'div',
                  { className: analysisTab === 1 && tabIndex === 1 ? 'trackAnalysisProcess visible' : 'trackAnalysisProcess hidden', style: parentVisible },
                  _react2['default'].createElement('div', { className: 'processClose', onClick: handleClose }),
                  _react2['default'].createElement(
                      'div',
                      { className: 'processTile' },
                      '轨迹纠偏'
                  ),
                  _react2['default'].createElement('div', { className: processSwitch, onClick: handleProcessSwitch }),
                  _react2['default'].createElement(
                      'div',
                      { className: 'processControl' },
                      _react2['default'].createElement(
                          'div',
                          { className: 'processControlItem' },
                          _react2['default'].createElement('input', { type: 'checkbox', id: 'denoise' }),
                          _react2['default'].createElement(
                              'label',
                              { htmlFor: 'denoise' },
                              '去噪'
                      ...
                      _react2['default'].createElement(
                          'div',
                          { className: 'processControlItem' },
                          _react2['default'].createElement('input', { type: 'checkbox', id: 'vacuate' }),
                          _react2['default'].createElement(
                              'label',
                              { htmlFor: 'vacuate' },
                              '抽稀'
                      ...
                      _react2['default'].createElement(
                          'div',
                          { className: 'processControlItem' },
                          _react2['default'].createElement('input', { type: 'checkbox', id: 'mapmatch' }),
                          _react2['default'].createElement(
                              'label',
                              { htmlFor: 'mapmatch' },
                              '绑路'
              ...
              _react2['default'].createElement(
                  'div',
                  { className: analysisTab === 2 && tabIndex === 1 ? 'trackAnalysisBehavior visible' : 'trackAnalysisBehavior hidden', style: parentVisible },
                  _react2['default'].createElement('div', { className: 'behaviorClose', onClick: handleClose }),
                  _react2['default'].createElement(
                      'div',
                      { className: 'behaviorTile' },
                      '驾驶行为分析'
                  ),
                  _react2['default'].createElement('div', { className: behaviorSwitch, onClick: handleBehaviorSwitch }),
                  _react2['default'].createElement(
                      'div',
                      { className: 'behaviorControl' },
                      _react2['default'].createElement(
                          'div',
                          { className: 'behaviorControlItem' },
                          _react2['default'].createElement(
                              'div',
                              { className: controlItemNum1 },
                              behaviorSpeeding
                          ),
                          _react2['default'].createElement(
                              'div',
                              { className: 'controlItemBot' },
                              _react2['default'].createElement('input', { type: 'checkbox', id: 'speeding' }),
                              _react2['default'].createElement(
                                  'label',
                                  { htmlFor: 'speeding' },
                                  '超速'
                      ...
                      _react2['default'].createElement('div', { className: 'controlItemLine' }),
                      _react2['default'].createElement(
                          'div',
                          { className: 'behaviorControlItem' },
                          _react2['default'].createElement(
                              'div',
                              { className: controlItemNum2 },
                              behaviorAcceleration
                          ),
                          _react2['default'].createElement(
                              'div',
                              { className: 'controlItemBot' },
                              _react2['default'].createElement('input', { type: 'checkbox', id: 'acceleration' }),
                              _react2['default'].createElement(
                                  'label',
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              'div',
                              { className: controlItemNum3 },
                              behaviorSteering
                          ),
                          _react2['default'].createElement(
                              'div',
                              { className: 'controlItemBot' },
                              _react2['default'].createElement('input', { type: 'checkbox', id: 'steering' }),
                              _react2['default'].createElement(
                                  'label',
                                  { htmlFor: 'steering' },
                                  '急转弯'
                      ...
                      _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                              'div',
                              { className: controlItemNum4 },
                              behaviorStaypoint
                          ),
                          _react2['default'].createElement(
                              'div',
                              { className: 'controlItemBot' },
                              _react2['default'].createElement('input', { type: 'checkbox', id: 'staypoint' }),
                              _react2['default'].createElement(
                                  'label',
                                  { htmlFor: 'staypoint' },
                                  '停留'

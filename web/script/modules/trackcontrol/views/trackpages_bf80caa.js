define('script/modules/trackcontrol/views/trackpages', function(require, exports, module) {
  ...
  var Trackpages = _react2['default'].createClass({
      displayName: 'Trackpages',
       ...
       *
       */
      listenListLoaded: function listenListLoaded() {
       ...
       *
       */
      listenInitpagetrack: function listenInitpagetrack() {
          this.setState({
              // 当前页码
              currentPage: 1,
              // 输入框中的页码
      ...
      handleJumppage: function handleJumppage(event) {
          ...
          _actionsTrackAction2['default'].tracklist(jumpPage);
      ...
      handleLastpage: function handleLastpage(event) {
          if (this.state.currentPage === 1 || this.state.cliking === 1) {
              ...
              _actionsTrackAction2['default'].tracklist(lastPage);
              this.setState({ cliking: 1 });
          }
      },
      /**
      ...
      handleNextpage: function handleNextpage(event) {
          if (this.state.currentPage === this.state.totalPage || this.state.cliking === 1) {
              ...
              _actionsTrackAction2['default'].tracklist(nextPage);
              this.setState({ cliking: 1 });
          }
      },
      /**

define('script/modules/trackcontrol/views/monitoronlinepage', function(require, exports, module) {
  ...
  var Monitoronlinepage = _react2['default'].createClass({
      displayName: 'Monitoronlinepage',
      ...
      componentDidMount: function componentDidMount() {
          ...
          setInterval(function () {
              _actionsTrackAction2['default'].searchonlineentity();
          }, 10000);
      },
       ...
       *
       */
      listenonlinelList: function listenonlinelList() {
      ...
      handleJumppage: function handleJumppage(event) {
          ...
          _actionsTrackAction2['default'].searchonlineentity(jumpPage);
      ...
      handleLastpage: function handleLastpage(event) {
          if (this.state.currentPage === 1 || this.state.cliking === 1) {
              ...
              _actionsTrackAction2['default'].searchonlineentity(lastPage);
              this.setState({ cliking: 1 });
          }
      },
      /**
      ...
      handleNextpage: function handleNextpage(event) {
          if (this.state.currentPage === this.state.totalPage || this.state.cliking === 1) {
              ...
              _actionsTrackAction2['default'].searchonlineentity(nextPage);
              this.setState({ cliking: 1 });
          }
      },
      /**
  ...
  exports['default'] = Monitoronlinepage;
